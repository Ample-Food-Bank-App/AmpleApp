...
const HomeScreen = props => {
    ...
    const startHandler = () => {
        if (selectedValue === '' && selectedOption === '') {
            Alert.alert('Your information is incomplete!', 'Please enter a location and/or select an action.', [{ text: 'Okay', style: 'cancel' }]);
            return;
        }
    ...
    if (!fontsLoaded) {
        ...
        return (
            ...
            <View style={styles.slide2}>
                ...
                <Text style={styles.subheading2}>Enter zipcode or use your phone's location to find nearby food banks.</Text>
            ...
            <View style={styles.slide3}>
                         <Text style={styles.textMain2}>Choose your action:</Text>
                            <TouchableOpacity
                            onPress={donateHandler}
                            style={{backgroundColor: donateColor, borderWidth: 3, borderColor: '#f4d3b3', borderRadius: 10,  width: '70%', 
                            ...
                            <Text></Text>
                            <Text style={styles.desc}>Help provide what</Text>
                            <Text style={styles.desc}>food banks need</Text>
                         </TouchableOpacity>
                         <TouchableOpacity
                         onPress={findHandler}
                          style={{backgroundColor: findColor, borderWidth: 3, borderColor: '#f4d3b3', borderRadius: 10,  width: '70%', 
                        ...
                        <Text></Text>
                        <Text style={styles.desc}>See available items</Text>
                        <Text style={styles.desc}>at food banks</Text>
                         </TouchableOpacity>
